...
def convert_sharegpt(
    ...
    Compared to the data used in standard DPO, our data includes a feature called “weight.”
    """
    outputs = {"prompt": [], "response": [], "system": [], "tools": [], "images": [],"weight":[]} 
    ...
    for i, messages in enumerate(examples[dataset_attr.messages]):        
        ...
        outputs["weight"].append(examples["weight"][i])
    ...
    features = Features.from_dict(
        {
            ...
            "images": [{"_type": "Image"}],
            "weight":{"dtype":"double", "_type":"Value"}
...
"""    if "weight" in column_names:
        mapped_dataset = mapped_dataset.add_column('weight', dataset["weight"])
        """ 
