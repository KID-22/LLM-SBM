...
class CustomDPOTrainer(DPOTrainer):
    ...
    def weight_dpo_loss(self, policy_chosen_logps, policy_rejected_logps, reference_chosen_logps, reference_rejected_logps,
    train_eval, weight, description = "Add the preference weights to the original dpo losses."
    ):
    ...
    def compute_preference_loss(
        ...
        if not self.finetuning_args.use_ref_model:
            ...
            if weight is not None:
                losses, chosen_rewards, rejected_rewards = self.weight_dpo_loss(
                    policy_chosen_logps, policy_rejected_logps, reference_chosen_logps, reference_rejected_logps, train_eval, weight,
                )
            else:
    ...
    def get_batch_loss_metrics(
        ...
        # losses = torch.pow(weight, self.finetuning_args.weight_alpha) * losses
